function load_notifications() 
{
	...
	$.ajax({
		url: global_base_url + "arkaofis/load_notifications",
		beforeSend: function () { 
...
{
	$.ajax({
		url: global_base_url + "arkaofis/load_notifications_unread",
		beforeSend: function () { 
		$('#loading_spinner_notification').fadeIn(10);
		$("#ajspinner_notification").addClass("spin");
	 	},
...
{
	window.location.href= global_base_url + "arkaofis/load_notification/" + id;
	return;
}
